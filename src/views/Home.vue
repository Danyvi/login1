                  ...
                  <v-row>
                    ...
                    <v-col cols="12" md="4" class="blue accent-3">
                      <v-card-text class="white--text mt-12">
                        ...
                        <h5 class="text-center">Enter your credential and start your journey with us</h5>
                      </v-card-text>
                  ...
                  <v-row class="fill-height">
                    <v-col cols="12" md="4" class="blue accent-3">
                      <v-card-text class="white--text mt-12">
                        ...
                        <h5 class="text-center">To be connected with us login with your personal info</h5>
                      </v-card-text>
                      <div class="text-center">
